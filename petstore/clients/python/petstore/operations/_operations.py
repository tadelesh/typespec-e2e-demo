...
def build_pets_get_request(pet_id: int, **kwargs: Any) -> HttpRequest:
...
def build_pets_update_request(pet_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pets_delete_request(pet_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pets_create_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pets_list_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pet_checkups_create_or_update_request(  # pylint: disable=name-too-long
    pet_id: int, checkup_id: int, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/pets/{petId}/checkups/{checkupId}"
    path_format_arguments = {
        "petId": _SERIALIZER.url("pet_id", pet_id, "int"),
        "checkupId": _SERIALIZER.url("checkup_id", checkup_id, "int"),
    }
...
def build_pet_checkups_list_request(pet_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/pets/{petId}/checkups"
    path_format_arguments = {
        "petId": _SERIALIZER.url("pet_id", pet_id, "int"),
    }
...
def build_pet_insurance_get_request(pet_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/pets/{petId}/insurance"
    path_format_arguments = {
        "petId": _SERIALIZER.url("pet_id", pet_id, "int"),
    }
...
def build_pet_insurance_update_request(pet_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_toys_get_request(pet_id: int, toy_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/pets/{petId}/toys/{toyId}"
    path_format_arguments = {
        "petId": _SERIALIZER.url("pet_id", pet_id, "int"),
        "toyId": _SERIALIZER.url("toy_id", toy_id, "int"),
    }
...
def build_toys_list_request(pet_id: int, *, name_filter: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    _params["nameFilter"] = _SERIALIZER.query("name_filter", name_filter, "str")
...
def build_toy_insurance_get_request(pet_id: int, toy_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/pets/{petId}/toys/{toyId}/insurance"
    path_format_arguments = {
        "petId": _SERIALIZER.url("pet_id", pet_id, "int"),
        "toyId": _SERIALIZER.url("toy_id", toy_id, "int"),
    }
...
def build_toy_insurance_update_request(pet_id: int, toy_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_checkups_create_or_update_request(checkup_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_checkups_list_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_owners_get_request(owner_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    _url = "/owners/{ownerId}"
    path_format_arguments = {
        "ownerId": _SERIALIZER.url("owner_id", owner_id, "int"),
    }
...
def build_owners_update_request(owner_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_owners_delete_request(owner_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_owners_create_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_owners_list_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_owner_checkups_create_or_update_request(  # pylint: disable=name-too-long
    owner_id: int, checkup_id: int, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/owners/{ownerId}/checkups/{checkupId}"
    path_format_arguments = {
        "ownerId": _SERIALIZER.url("owner_id", owner_id, "int"),
        "checkupId": _SERIALIZER.url("checkup_id", checkup_id, "int"),
    }
...
def build_owner_checkups_list_request(owner_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/owners/{ownerId}/checkups"
    path_format_arguments = {
        "ownerId": _SERIALIZER.url("owner_id", owner_id, "int"),
    }
...
def build_owner_insurance_get_request(owner_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/owners/{ownerId}/insurance"
    path_format_arguments = {
        "ownerId": _SERIALIZER.url("owner_id", owner_id, "int"),
    }
...
def build_owner_insurance_update_request(owner_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class PetsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~petstore.PetStoreClient`'s
        :attr:`pets` attribute.
    """
    ...
    def get(self, pet_id: int, **kwargs: Any) -> _models.Pet:
    ...
    def update(self, pet_id: int, properties: Union[_models.PetUpdate, JSON, IO[bytes]], **kwargs: Any) -> _models.Pet:
        """Updates an existing instance of the resource.
    ...
    def delete(self, pet_id: int, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @overload
    def create(self, resource: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.Pet:
        """Creates a new instance of the resource.
    ...
    @overload
    def create(self, resource: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.Pet:
        """Creates a new instance of the resource.
    ...
    def create(self, resource: Union[_models.PetCreate, JSON, IO[bytes]], **kwargs: Any) -> _models.Pet:
        """Creates a new instance of the resource.
    ...
    def list(self, **kwargs: Any) -> _models.PetCollectionWithNextLink:
...
class PetCheckupsOperations:
    ...
    def list(self, pet_id: int, **kwargs: Any) -> _models.CheckupCollectionWithNextLink:
...
class PetInsuranceOperations:
    ...
    def get(self, pet_id: int, **kwargs: Any) -> _models.Insurance:
...
class ToysOperations:
    ...
    def get(self, pet_id: int, toy_id: int, **kwargs: Any) -> _models.Toy:
        """Gets an instance of the resource.
    ...
    def list(self, pet_id: int, *, name_filter: str, **kwargs: Any) -> _models.ToyCollectionWithNextLink:
        """list.
...
class ToyInsuranceOperations:
    ...
    def get(self, pet_id: int, toy_id: int, **kwargs: Any) -> _models.Insurance:
        """Gets the singleton resource.
...
class CheckupsOperations:
    ...
    def list(self, **kwargs: Any) -> _models.CheckupCollectionWithNextLink:
        """Lists all instances of the resource.
...
class OwnersOperations:
    ...
    def get(self, owner_id: int, **kwargs: Any) -> _models.Owner:
        """Gets an instance of the resource.
    ...
    def delete(self, owner_id: int, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Deletes an existing instance of the resource.
    ...
    @overload
    def create(self, resource: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.Owner:
        """Creates a new instance of the resource.
    ...
    @overload
    def create(self, resource: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.Owner:
        """Creates a new instance of the resource.
    ...
    def create(self, resource: Union[_models.OwnerCreate, JSON, IO[bytes]], **kwargs: Any) -> _models.Owner:
        """Creates a new instance of the resource.
    ...
    def list(self, **kwargs: Any) -> _models.OwnerCollectionWithNextLink:
        """Lists all instances of the resource.
...
class OwnerCheckupsOperations:
    ...
    def list(self, owner_id: int, **kwargs: Any) -> _models.CheckupCollectionWithNextLink:
        """Lists all instances of the extension resource.
...
class OwnerInsuranceOperations:
    ...
    def get(self, owner_id: int, **kwargs: Any) -> _models.Insurance:
        """Gets the singleton resource.
