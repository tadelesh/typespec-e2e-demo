...
public final class ToyInsurancesImpl {
    ...
    public interface ToyInsurancesService {
        ...
        Response<Insurance> updateSync(@HostParam("endpoint") String endpoint, @PathParam("petId") int petId,
            ...
            @HeaderParam("Accept") String accept, @BodyParam("application/json") BinaryData properties,
    ...
    public Response<Insurance> updateWithResponse(int petId, long toyId, BinaryData properties,
        ...
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), petId, toyId, contentType, accept, properties,
            requestOptions);
    }
}
