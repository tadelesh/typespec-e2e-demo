...
|                              | JS           | Qiaoqiao  | :running_man:            | 12/31   | [Code](https://github.com/allenjzhang/typespec-e2e-demo/tree/main/petstore/clients/javascript)       | needs to upgrade `ts-http-runtime` to preview version            |
