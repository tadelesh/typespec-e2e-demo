...
| ToDo App                     |              |           |                          |         |          |             |
|                              | C#           | Dapeng    | :running_man:            | 1/15    | [Code](https://github.com/allenjzhang/typespec-e2e-demo/tree/main/todoApp/clients/dotnet) | `http-client-csharp` now has a bug on multi-line descriptions |
