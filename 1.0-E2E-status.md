...
|                              | JS           | Qiaoqiao  | :running_man:            | 12/31   | [Link](https://github.com/allenjzhang/typespec-e2e-demo/tree/main/petstore/clients/javascript)       | needs to upgrade `ts-http-runtime` to preview version            |
...
|                              | JS           | Qiaoqiao  | :running_man:            | 1/15    | [Link](https://github.com/allenjzhang/typespec-e2e-demo/pull/31/files)        | we have a few features blocked by tcgc sdk method adoption [link](https://github.com/Azure/autorest.typescript/issues?q=is%3Aissue%20state%3Aopen%20label%3Anon-azure%20label%3Ablocked)            |
