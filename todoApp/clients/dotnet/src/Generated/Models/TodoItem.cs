...
namespace Todo.Models
{
    ...
    public partial class TodoItem
    {
        ...
        internal TodoItem(long id, string title, long createdBy, long? assignedTo, string description, TodoItemStatus status, DateTimeOffset createdAt, DateTimeOffset updatedAt, DateTimeOffset? completedAt, BinaryData labels, string dummy, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Title = title;
            CreatedBy = createdBy;
