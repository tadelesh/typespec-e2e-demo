...
namespace Todo.Models
{
    ...
    public partial class CreateResponse
    {
        ...
        internal CreateResponse(string title, TodoItemStatus status)
        {
            Title = title;
            Status = status;
        }

        internal CreateResponse(long id, string title, long createdBy, long? assignedTo, string description, TodoItemStatus status, DateTimeOffset createdAt, DateTimeOffset updatedAt, DateTimeOffset? completedAt, BinaryData labels, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Title = title;
            CreatedBy = createdBy;
