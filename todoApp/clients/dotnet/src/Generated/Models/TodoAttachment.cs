...
namespace Todo.Models
{
    ...
    public partial class TodoAttachment
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TodoAttachment"/>. </summary>
        ...
        public TodoAttachment(string filename, string mediaType, BinaryData contents)
        {
        ...
        internal TodoAttachment(string filename, string mediaType, BinaryData contents, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Filename = filename;
            MediaType = mediaType;
            Contents = contents;
