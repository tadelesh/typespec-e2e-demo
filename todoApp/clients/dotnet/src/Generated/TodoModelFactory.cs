...
namespace Todo.Models
{
    ...
    public static partial class TodoModelFactory
    {
        ...
        public static TodoFileAttachment TodoFileAttachment(string filename = default, string mediaType = default, BinaryData contents = default)
        {

            return new TodoFileAttachment(filename, mediaType, contents, additionalBinaryDataProperties: null);
        }
        ...
        public static CreateResponse CreateResponse(long id = default, string title = default, long createdBy = default, long? assignedTo = default, string description = default, TodoItemStatus status = default, DateTimeOffset createdAt = default, DateTimeOffset updatedAt = default, DateTimeOffset? completedAt = default, BinaryData labels = default)
        {
...
but is otherwise not visible (and hashed by the backend). </param>
        ...
        public static User User(long id = default, string username = default, string email = default, string password = default, bool validated = default)
        {
        ...
        /// <summary> The CreateResponse1. </summary>
        /// <param name="id"> An autogenerated unique id for the user. </param>
        /// <param name="username"> The user's username. </param>
        /// <param name="email"> The user's email address. </param>
        /// <param name="token"> The token to use to construct the validate email address url. </param>
        /// <returns> A new <see cref="Models.CreateResponse1"/> instance for mocking. </returns>
        public static CreateResponse1 CreateResponse1(long id = default, string username = default, string email = default, string token = default)
        {

            return new CreateResponse1(id, username, email, token, additionalBinaryDataProperties: null);
        }
    }
}
