...
public final class CreateResponse implements JsonSerializable<CreateResponse> {
     ...
     */
    @Metadata(generated = true)
    private CreateResponse(String title, TodoItemStatus status) {
        this.title = title;
        this.status = status;
    }
    ...
    public static CreateResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            CreateResponse deserializedCreateResponse = new CreateResponse(title, status);
            deserializedCreateResponse.id = id;
            deserializedCreateResponse.createdBy = createdBy;
            deserializedCreateResponse.createdAt = createdAt;
            deserializedCreateResponse.updatedAt = updatedAt;
            deserializedCreateResponse.assignedTo = assignedTo;
            deserializedCreateResponse.description = description;
            deserializedCreateResponse.completedAt = completedAt;
            deserializedCreateResponse.labels = labels;
