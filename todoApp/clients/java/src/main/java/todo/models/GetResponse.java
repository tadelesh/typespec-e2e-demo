...
public final class GetResponse implements JsonSerializable<GetResponse> {
     ...
     */
    @Metadata(generated = true)
    private GetResponse(String title, TodoItemStatus status) {
        this.title = title;
        this.status = status;
    }
    ...
    public static GetResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            GetResponse deserializedGetResponse = new GetResponse(title, status);
            deserializedGetResponse.id = id;
            deserializedGetResponse.createdBy = createdBy;
            deserializedGetResponse.createdAt = createdAt;
            deserializedGetResponse.updatedAt = updatedAt;
            deserializedGetResponse.assignedTo = assignedTo;
            deserializedGetResponse.description = description;
            deserializedGetResponse.completedAt = completedAt;
            deserializedGetResponse.labels = labels;
