...
/**
 * The CreateJsonResponse model.
 */
@Metadata(conditions = { TypeConditions.IMMUTABLE })
public final class CreateJsonResponse implements JsonSerializable<CreateJsonResponse> {
    /*
    ...
    /**
     * Creates an instance of CreateJsonResponse class.
     * 
     * @param title the title value to set.
     * @param status the status value to set.
     */
    @Metadata(generated = true)
    private CreateJsonResponse(String title, TodoItemStatus status) {
        this.title = title;
        this.status = status;
    }
    ...
    /**
     * Reads an instance of CreateJsonResponse from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CreateJsonResponse if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CreateJsonResponse.
     */
    @Metadata(generated = true)
    public static CreateJsonResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            CreateJsonResponse deserializedCreateJsonResponse = new CreateJsonResponse(title, status);
            deserializedCreateJsonResponse.id = id;
            deserializedCreateJsonResponse.createdBy = createdBy;
            deserializedCreateJsonResponse.createdAt = createdAt;
            deserializedCreateJsonResponse.updatedAt = updatedAt;
            deserializedCreateJsonResponse.assignedTo = assignedTo;
            deserializedCreateJsonResponse.description = description;
            deserializedCreateJsonResponse.completedAt = completedAt;
            deserializedCreateJsonResponse.labels = labels;

            return deserializedCreateJsonResponse;
        });
    }
}
