...
namespace Getitdone
{
    ...
    public partial class Labels
    {
        ...
        internal PipelineMessage CreateGetPersonalLabelsRequest(RequestOptions options)
        {
        ...
        internal PipelineMessage CreateCreateLabelRequest(BinaryContent content, RequestOptions options)
        {
            PipelineMessage message = Pipeline.CreateMessage();
