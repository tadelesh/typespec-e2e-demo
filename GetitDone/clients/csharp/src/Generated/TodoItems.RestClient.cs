...
namespace Getitdone
{
    ...
    public partial class TodoItems
    {
        ...
        internal PipelineMessage CreateGetTodoItemsRequest(RequestOptions options)
        {
        ...
        internal PipelineMessage CreateCreateTodoItemRequest(BinaryContent content, RequestOptions options)
        {
            PipelineMessage message = Pipeline.CreateMessage();
